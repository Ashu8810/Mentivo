...
import { ArrowLeft, Target, ChevronRight, Activity } from "lucide-react";
          ...
          >
            ...
            <div className="p-8 md:p-12 flex-1 flex flex-col pt-12">
              ...
              <p className="text-[17px] text-[#475569] leading-[1.8] mb-12 max-w-[580px]">
                Your profile matrix reveals a distinct natural inclination: your intersection of empathy and generative thinking points toward fields where human interaction and systemic design meet.
              </p>
              ...
              <div className="mt-auto flex flex-col sm:flex-row items-start sm:items-center justify-between gap-6">
                <div className="flex items-center gap-4">
                  <div className="w-[72px] h-[72px] rounded-full bg-emerald-50/80 border border-emerald-100 flex items-center justify-center shadow-inner">
                     <span className="text-[22px] font-bold text-[#059669]">85%</span>
                  </div>
          ...
          >
             <div className="flex-1">
               ...
               <p className="text-[15px] text-[#64748B] leading-[1.7] max-w-[280px]">
                 A pivot into Psychology or Law anchors your strong communication skills into highly stable, yet deeply human-centric, professional services.
               </p>
             </div>
